local config = {
    ...
    [100539151525414] = "https://api.jnkie.com/api/v1/luascripts/public/5ad011b0e9815baf20cb915494d9bbbfa03ccb625fd76538f370491bf2bf118c/download", -- Fisch for new players
